...
const NewFunderRequest = () => {
  ...
  const newFunderListing = () => {
    const data = { user_type: "FU", is_approved: "pending", };
      ...
      <div className="patients-search">
        <div className="custom-search">
          ...
          <DebounceInput
            ...
            onChange={(e) => searchNewFunders(e.target.value)}
          />
        </div>
      </div>
