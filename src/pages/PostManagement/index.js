...
import { deletePost, getAllPostList } from '../../actions/Post';
...
const AllPost = () => {
  ...
  // Searching
  const SearchAllPosts = (value) => {
    const data = { search_data: value.trim(), modelname: "feed", app_name: 'allpost', news_feed_type: "ALL" }
      ...
      <div className='patients-search'>
        <div className='custom-search'>
          ...
          <DebounceInput
            ...
            onChange={(e) => SearchAllPosts(e.target.value)}
          />
        </div>
      </div>
        ...
        <div className='post-detail'>
          ...
          <div className='footer-post'>
            ...
            {postId?.comment === 0 ?
              ...
              :
              <span className='comment' onClick={() => navigate(`/post-management/all-posts/${postId?.id}/all-post-comments`)} ><CommentIcon />{postId?.comment}  {postId?.comment <= 1 ? "Comment" : "Comments"}</span>
            }
          </div>
        </div>
      </Modal>
